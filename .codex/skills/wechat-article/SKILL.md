---
name: wechat-article
description: Turn investment research into a Chinese WeChat-style article while preserving factual rigor and source discipline.
---

# Wechat Article

This is the Codex-adapted derivative of `skills/wechat-article.md`. Treat the original file as the Claude command source and this file as the executable Codex skill for this local OMX/Codex profile.
...
对 the user-supplied company, ticker, industry, or topic 进行深度研究，产出一篇可直接发布的微信公众号文章。三个Agent各司其职：作者写深度初稿，编辑精修结构和表达，读者从目标受众视角审读。
