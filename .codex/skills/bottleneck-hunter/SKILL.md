...
description: Find AI-era supply-chain bottleneck investment opportunities with Chinese research discipline, current sources, and validation gates.
---

# Bottleneck Hunter

This is the Codex-adapted derivative of `skills/bottleneck-hunter.md`. Treat the original file as the Claude command source and this file as the executable Codex skill for this local OMX/Codex profile.
...
对 the user-supplied company, ticker, industry, or topic 超级趋势执行供应链瓶颈扫描与套利机会挖掘。
...
对每个确认的超级趋势执行类似拆解。使用current web research搜索：
...
搜索方式：
- current web research "{瓶颈环节} supplier listed company"
- current web research "{瓶颈环节} manufacturer stock"
- current web research "{瓶颈产品} market share company"
