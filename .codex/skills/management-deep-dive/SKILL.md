...
description: Research management quality, incentives, culture, and capital allocation in Chinese using value-investing standards.
---

# Management Deep Dive

This is the Codex-adapted derivative of `skills/management-deep-dive.md`. Treat the original file as the Claude command source and this file as the executable Codex skill for this local OMX/Codex profile.
...
对 the user-supplied company, ticker, industry, or topic 进行管理层深度研究。
...
使用 current web research 确认以下关键人物：
...
确认关键人物后，使用 Codex subagent or sequential research lane 工具启动多个后台 Agent **并行**收集以下数据：
