...
description: Review and improve a portfolio in Chinese across concentration, thesis, valuation, risk, and rebalancing discipline.
---

# Portfolio Review

This is the Codex-adapted derivative of `skills/portfolio-review.md`. Treat the original file as the Claude command source and this file as the executable Codex skill for this local OMX/Codex profile.
...
对 the user-supplied company, ticker, industry, or topic 执行投资组合审视与优化。
...
使用 Codex subagent or sequential research lane 工具启动后台 Agent，通过 current web research 为每个持仓并行获取：
