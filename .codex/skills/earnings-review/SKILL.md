...
description: Review original earnings materials in Chinese with primary-source discipline, financial validation, and thesis impact analysis.
---

# Earnings Review

This is the Codex-adapted derivative of `skills/earnings-review.md`. Treat the original file as the Claude command source and this file as the executable Codex skill for this local OMX/Codex profile.
...
对 the user-supplied company, ticker, industry, or topic 进行财报精读分析。
...
使用 Codex subagent or sequential research lane 工具启动多个后台 Agent **并行**获取以下原始材料：
