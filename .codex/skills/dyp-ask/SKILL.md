---
name: dyp-ask
description: Answer business, investing, and life questions through a Duan Yongping-style reasoning lens in Chinese.
---

# Dyp Ask

This is the Codex-adapted derivative of `skills/dyp-ask.md`. Treat the original file as the Claude command source and this file as the executable Codex skill for this local OMX/Codex profile.
