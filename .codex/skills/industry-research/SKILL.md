...
description: Produce a Chinese industry-wide investment research report with value-chain mapping, company screening, and validation.
---

# Industry Research

This is the Codex-adapted derivative of `skills/industry-research.md`. Treat the original file as the Claude command source and this file as the executable Codex skill for this local OMX/Codex profile.
...
对 the user-supplied company, ticker, industry, or topic 行业进行系统化产业链投资研究。
...
使用 Codex subagent or sequential research lane 工具启动后台 Agent，全面搜索该行业所有上市公司。
