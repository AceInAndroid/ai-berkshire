---
name: longbridge-data
description: "AI Berkshire skill: Longbridge MCP 只读投研数据底稿. Source: skills/longbridge-data.md."
---

## Codex adapter note

This skill is generated from `skills/longbridge-data.md` so Claude Code and Codex users share one canonical workflow.
